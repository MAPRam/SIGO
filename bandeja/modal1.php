...
<!-- <script src="js/funciones.js"></script> -->
    <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          ...
          <div class="form-group input-group">
            <span class="input-group-addon" style="width:150px;">Escribe Mensaje:</span>
						<input type="text" style="width:350px;" class="form-control" id="id_mensaje_turnado">
          </div>
            ...
            <select class="form-control" style="width: 350px;" id="destinatario">
              ...
              <?php
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-info" id="reenviar">Enviar</button>
                </div>
            </div>
        </div>
    </div>
