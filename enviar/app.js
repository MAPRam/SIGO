...
formulario.addEventListener('submit', function(e){
    ...
    var pri = document.getElementById("prioridad").selectedIndex;
    var pri2 = document.getElementById("prioridad").options;
    //document.getElementById("submit").disabled = true;
    var pri3 = pri2[pri].id;
